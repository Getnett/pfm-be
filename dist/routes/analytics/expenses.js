...
router.get("/api/analytics/expenses/monthly_total_spend", (0, async_error_handler_1.default)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    const { month, year } = req.query;
    const resData = yield analytics_1.default.getMonthlyTotalSpend(Number(month), Number(year));
    res.status(200).send(resData);
})));
